...
let colors_name="My_AutumnLeaf_Bold"


" Colors for the User Interface.

hi Cursor	guibg=#aa7733   guifg=#ffeebb   gui=NONE
hi Normal	guibg=#fffdfa	guifg=black	gui=none
hi NonText	guibg=#eafaea   guifg=#000099   gui=NONE
...
hi ErrorMsg	    guibg=bg	guifg=#cc0000   gui=NONE
hi ModeMsg	    guibg=bg	guifg=#003399   gui=none
hi link	MoreMsg	    ModeMsg
hi link Question    ModeMsg
hi WarningMsg	    guibg=bg	guifg=#cc0000   gui=NONE

hi StatusLine	guibg=#ffeebb	guifg=black	gui=NONE
...
hi Character	guibg=bg    guifg=#003399 gui=NONE
...
hi Typedef		guibg=bg    guifg=#009900 gui=NONE

hi Special	    guibg=bg	    guifg=fg	    gui=none
hi SpecialChar	    guibg=bg	    guifg=fg	    gui=NONE
...
hi Title    guibg=bg	guifg=fg    	gui=NONE
...
hi String	ctermbg=bg  ctermfg=9  cterm=NONE
hi Character	ctermbg=bg  ctermfg=9  cterm=NONE
hi Number	ctermbg=bg  ctermfg=9  cterm=NONE
hi Boolean	ctermbg=bg  ctermfg=9  cterm=NONE
hi Float	ctermbg=bg  ctermfg=9  cterm=NONE
hi Function	ctermbg=bg  ctermfg=9  cterm=NONE
hi Statement	ctermbg=bg  ctermfg=9  cterm=NONE
hi Conditional	ctermbg=bg  ctermfg=6  cterm=NONE
hi Repeat	ctermbg=bg  ctermfg=6  cterm=NONE
hi Operator	ctermbg=bg  ctermfg=6  cterm=NONE
hi Exception	ctermbg=bg  ctermfg=2  cterm=NONE
hi PreProc	ctermbg=bg  ctermfg=6
hi Include	ctermbg=bg  ctermfg=2  cterm=NONE
hi Type		ctermbg=bg  ctermfg=2  cterm=NONE
hi Typedef	ctermbg=bg  ctermfg=2  cterm=NONE
hi Special	ctermbg=bg  ctermfg=fg cterm=NONE
hi Tag		ctermbg=bg  ctermfg=9  cterm=NONE
hi SpecialComment ctermbg=7 ctermfg=4
hi Underlined	ctermbg=bg  ctermfg=9  cterm=underline
hi Title	ctermbg=bg  ctermfg=fg cterm=NONE 
