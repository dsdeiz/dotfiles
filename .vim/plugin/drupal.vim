" Take from http://drupal.org/project/vimrc
" http://drupalcode.org/project/vimrc.git/blob_plain/refs/heads/7.x-1.x:/plugin/drupal.vim
...
augroup Drupal
  ...
  autocmd BufRead,BufNewFile *.tpl.php,*.module,*.install,*.inc,*.profile,*.theme,*.engine,*.test set filetype=php | call s:DrupalInit()
augroup END
