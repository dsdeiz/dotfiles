...
exe 'hi StatusLine     guifg='.s:white             .' guibg='.s:grey            .' gui=NONE,underline'
exe 'hi StatusLineNC   guifg='.s:lightgrey         .' guibg='.s:grey            .' gui=NONE,underline'
...
exe 'hi TODO           guifg='.s:grey_blue         .' guibg='.s:darkgrey        .' gui=NONE,bold'
