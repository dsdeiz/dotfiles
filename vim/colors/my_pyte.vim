...
if version >= 700
  ...
  hi TabLineSel guifg=black guibg=#f0f0f0 gui=NONE,bold
...
hi StatusLine guifg=white guibg=#8090a0 gui=bold,NONE
...
hi Todo       guifg=#a0b0c0 guibg=NONE gui=NONE,bold,underline
...
" Diff
hi DiffChange guifg=NONE guibg=#e0e0e0 gui=NONE,bold
hi DiffText guifg=NONE guibg=#f0c8c8 gui=NONE,bold
hi DiffAdd guifg=NONE guibg=#c0e0d0 gui=NONE,bold
hi DiffDelete guifg=NONE guibg=#f0e0b0 gui=NONE,bold
